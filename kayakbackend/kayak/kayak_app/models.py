...
class Flight(models.Model):
    destiny = models.ForeignKey(Country, on_delete=models.CASCADE, related_name="destiny_state_location" , to_field="state_location")
    origin = models.ForeignKey(Country, on_delete=models.CASCADE,related_name="origin_state_location", to_field="state_location")
    ...
    departure_airport = models.ForeignKey(Airport, on_delete=models.CASCADE, related_name="departure_airport_name", to_field="airport_name")
    arrive_airport = models.ForeignKey(Airport, on_delete=models.CASCADE, related_name="arrive_airport_name", to_field="airport_name")
